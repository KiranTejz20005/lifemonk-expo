...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity_instructions: Schema.Attribute.RichText;
    activity_requires_proof: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    chapter_type: Schema.Attribute.Enumeration<
      ['video', 'text', 'quiz', 'activity', 'mixed']
    > &
      Schema.Attribute.Required;
    ...
    xano_chapter_id: Schema.Attribute.Integer;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instructor_bio: Schema.Attribute.Text;
    instructor_image: Schema.Attribute.Media<'images'>;
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::quiz.quiz'> &
      Schema.Attribute.Private;
    pass_score: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<100>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    xano_chapter_id: Schema.Attribute.Integer;
    xano_quiz_id: Schema.Attribute.Integer;
  };
}
